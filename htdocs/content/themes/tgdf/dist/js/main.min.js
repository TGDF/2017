...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _skelMin = __webpack_require__(1);
	
	var _skelMin2 = _interopRequireDefault(_skelMin);
	...
	*/
	...
	(function ($) {
		...
		$(function () {
			...
			_skelMin2.default.on('+mobile -mobile', function () {
				$.prioritize('.important\\28 mobile\\29', _skelMin2.default.breakpoint('mobile').active);
			});
			...
			if (_skelMin2.default.vars.os == 'wp' && _skelMin2.default.vars.osVersion < 10) $('#titleBar, #navPanel, #page-wrapper').css('transition', 'none');
		});
	})(jQuery);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	!function (e) {
	  "use strict";
	  var t = { config: { width: "device-width", height: "", scalable: !0, breakpoints: {} }, init: function init(i) {
	      return e.extend(t.config, i), e.addStateHandler("viewport", t.stateHandler), e.attach(e.newAttachment("mv", t.newViewportMeta("initial-scale=1"), 1, !0)), "ie" == e.vars.browser && e.vars.IEVersion >= 10 && (e.attach(e.newAttachment("mVie", e.newStyle("@-ms-viewport{width:device-width}"), 1, !0)), window.setTimeout(function () {
	        var e = document.getElementsByTagName("body")[0],
	            t = e.style.height;e.style.height = "10000px", window.setTimeout(function () {
	          e.style.height = t;
	        }, 250);
	      }, 250)), e;
	    }, newViewportMeta: function newViewportMeta(e) {
	      var t = document.createElement("meta");return t.name = "viewport", t.content = e, t;
	    }, stateHandler: function stateHandler() {
	      var i, n, a;return n = e.generateStateConfig({ width: t.config.width, height: t.config.height, scalable: t.config.scalable }, t.config.breakpoints), a = [], a.push("user-scalable=" + (n.scalable ? "yes" : "no")), n.width && a.push("width=" + n.width), n.height && a.push("height=" + n.height), "device-width" == n.width && a.push("initial-scale=1"), i = e.newAttachment("mv-" + e.stateId, t.newViewportMeta(a.join(",")), 1), [i];
	    } };e.viewport = t.init;
	}(_skelMin2.default); /* skel-viewport.js v3.0.1 | (c) skel.io | MIT licensed */
